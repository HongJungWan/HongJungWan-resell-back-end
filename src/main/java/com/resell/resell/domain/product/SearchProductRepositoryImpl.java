...
import com.resell.resell.controller.dto.ProductDto.SearchCondition;
...
import com.resell.resell.domain.trade.QTrade;
...
import static com.resell.resell.domain.product.QProduct.product;
import static com.resell.resell.domain.trade.QTrade.trade;
...
public class SearchProductRepositoryImpl implements SearchProductRepository {
    ...
    @Override
    public Page<ThumbnailResponse> findAllBySearchCondition(SearchCondition condition, Pageable pageable) {
